...
SELECT COUNT(*) FROM reparto WHERE actores = 'Harrison Ford'; --en cuantos id está Harrison
...
--(2 punto)
-- SELECT MAX (LENGTH (Pelicula)) FROM peliculas; -- esta no da el noombre de la peli, sólo la longitud.
